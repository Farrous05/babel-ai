...
MODEL="${MODEL:-llama3.2:3b-instruct-fp16}"
...
export LLAMA_3_2_3B_LOCAL_BASE_URL="http://localhost:$PORT/v1/"
export LLAMA_3_2_3B_LOCAL_API_KEY="ollama"
